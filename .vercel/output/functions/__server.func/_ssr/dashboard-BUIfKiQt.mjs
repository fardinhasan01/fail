...
import { j as useUser, A as AppShell, k as liveClasses, w as activityBank, s as subjects } from "./router-DlWKGgSZ.mjs";
...
import { d as University, k as MessageCircleHeart, J as Flame, af as Star, T as Trophy, aq as Target, j as GraduationCap, h as Search, g as Users, o as Video, e as BookOpen, ar as MapPinned, z as Play, i as ArrowRight, S as Sparkles, as as Calendar } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 md:px-8 py-6 md:py-8 max-w-7xl mx-auto space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex flex-wrap items-end justify-between gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/school", className: "px-5 py-3 rounded-2xl bg-white font-semibold shadow-soft hover:shadow-glow flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-3 lg:grid-cols-[1.1fr_0.9fr]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-[2rem] p-6 md:p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 rounded-full bg-brand-green/10 px-3 py-1 text-xs font-semibold text-brand-green", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(University, { className: "h-3.5 w-3.5" }),
                " ",
                schoolLabel
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-2xl font-bold", children: "Your school-linked learning home" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm leading-6 text-muted-foreground", children: "Use the national ecosystem to register schools, create student IDs, search content, and join competitions." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/students", className: "inline-flex items-center gap-2 rounded-2xl bg-gradient-hero px-4 py-3 text-sm font-semibold text-white shadow-soft", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 grid grid-cols-2 gap-3 md:grid-cols-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DashLink, { to: "/school", label: "স্কুল", icon: University }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DashLink, { to: "/search", label: "Search", icon: Search }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DashLink, { to: "/competitions", label: "Competitions", icon: Trophy })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 xl:grid-cols-2 gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/library", className: "glass rounded-3xl p-5 hover:shadow-glow hover:scale-[1.02] transition-all", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-gradient-blue text-white grid place-items-center shadow-soft mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-5 h-5" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "glass-strong rounded-3xl p-6 md:p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/quiz", className: "text-sm font-medium text-primary hover:underline", children: "কুইজ বোর্ড খুলুন" })
        ] }),
...
function DashLink({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to, className: "rounded-2xl border border-border bg-background/80 p-4 text-center shadow-soft hover:shadow-glow", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "mx-auto h-5 w-5 text-primary" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-sm font-semibold", children: label })
  ] });
}
export {
