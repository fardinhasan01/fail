...
const makeMathQuestion = (classLevel, variant) => {
  ...
  if (classLevel === 1) {
    ...
    const { options: options2, answer: answer2 } = placeCorrect(String(correct2), [String(correct2 - 1), String(correct2 + 1), String(correct2 + 2)], seed);
    return {
  ...
  if (classLevel === 2) {
    ...
    const correct2 = a2 - b2;
    const { options: options2, answer: answer2 } = placeCorrect(String(correct2), [String(correct2 - 1), String(correct2 + 1), String(correct2 + 3)], seed);
    return {
      prompt: `What is ${a2} - ${b2}?`,
      options: options2,
      answer: answer2,
  ...
  if (classLevel === 3) {
    ...
    const correct2 = a2 * b2;
    const { options: options2, answer: answer2 } = placeCorrect(String(correct2), [String(correct2 - a2), String(correct2 + b2), String(correct2 + a2)], seed);
    return {
      prompt: `What is ${a2} × ${b2}?`,
      options: options2,
      answer: answer2,
  ...
  if (classLevel === 4) {
    ...
    const { options: options2, answer: answer2 } = placeCorrect(String(quotient), [String(quotient - 1), String(quotient + 1), String(quotient + 2)], seed);
    return {
...
const makeEnglishQuestion = (classLevel, variant) => {
  ...
  if (classLevel === 3) {
    ...
    const { options: options2, answer: answer2 } = placeCorrect(correct2, wrongs2.length >= 3 ? wrongs2 : ["hot", "big", "fast"], seed);
    return {
  ...
  if (classLevel === 4) {
    ...
    const wrongs2 = [sentence + "!", sentence.charAt(0).toUpperCase() + sentence.slice(1), sentence + "?"];
    const { options: options2, answer: answer2 } = placeCorrect(correct2, wrongs2, seed);
    return {
...
const categoryNames = ["গণিত", "ইংরেজি", "বাংলা", "বিজ্ঞান", "সাধারণ জ্ঞান"];
const buildQuizBank = () => {
  const bank = [];
