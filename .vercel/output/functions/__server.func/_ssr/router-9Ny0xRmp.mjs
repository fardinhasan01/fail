...
import { S as Sparkles, M as Maximize2, V as Volume2, a as VolumeX, C as Clock3, T as Trophy, b as CircleCheck, Z as Zap, R as RotateCcw, c as ShieldCheck, A as Award, F as FolderPlus, U as UserRoundPlus, B as BadgeCheck, L as LayoutDashboard, d as University, e as BookOpen, G as Globe, W as WandSparkles, f as LibraryBig, g as Users, h as Search, i as ArrowRight, D as Droplet, j as Moon, k as Tv, l as Flame, H as House, m as GraduationCap, n as MessageCircleHeart, o as Activity, p as Brain, q as Swords, P as Palette, r as Video, s as ScrollText, t as DoorOpen, u as Bell, X, v as Mic } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-hyFIqmXs.css";
...
const $$splitComponentImporter$o = () => import("./subjects-gd3E7m69.mjs");
...
const $$splitComponentImporter$n = () => import("./students-CnaMEPgs.mjs");
...
const $$splitComponentImporter$m = () => import("./student-health-BsSLhkJa.mjs");
...
const $$splitComponentImporter$l = () => import("./special-game-DOwAGZdA.mjs");
...
const $$splitComponentImporter$k = () => import("./search-EmRaOKlw.mjs");
...
function VoiceOrb({ className }) {
  ...
  const processCommand = (commandText) => {
    ...
    const commands = [
      ...
      {
        keywords: ["সার্চ", "search", "খোঁজ", "অনুসন্ধান"],
        action: () => {
          navigate({ to: "/search" });
          speak("সার্চ পেইজ ওপেন করা হচ্ছে।");
          setResponse("সার্চ পেইজ ওপেন করা হচ্ছে...");
        }
      },
      {
      ...
      },
      {
        ...
        action: () => {
          ...
          speak("লাইভ হোয়াইটবোর্ড ওপেন করা হচ্ছে।");
          setResponse("লাইভ হোয়াইটবোর্ড ওপেন করা হচ্ছে...");
        }
      },
      {
    ...
    const matched = commands.find(
      (cmd) => cmd.keywords.some((keyword) => text.includes(keyword))
    );
    if (matched) {
      matched.action();
    } else {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        className: cn(
          ...
          isListening ? "bg-gradient-to-r from-pink-500 to-rose-600 shadow-[0_0_25px_rgba(244,63,94,0.6)]" : "bg-gradient-to-r from-cyan-400 to-indigo-500 shadow-[0_0_20px_rgba(6,182,212,0.4)]"
        ),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: cn(
                ...
                isListening ? "border-rose-300 animate-spin scale-110 speed-fast" : "border-cyan-300 animate-spin"
              ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: cn(
                ...
                isListening ? "border-pink-200 animate-spin-reverse scale-105" : "border-indigo-200 animate-spin-reverse"
              ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: isListening ? /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "h-4.5 w-4.5 animate-pulse" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "h-4.5 w-4.5" })
            }
          )
        ]
      }
    ),
    showPanel && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-0 bottom-16 md:bottom-20 w-[280px] md:w-[320px] glass-strong rounded-[2rem] border border-border shadow-glow p-5 flex flex-col gap-3 text-foreground animate-in slide-in-from-bottom-5 fade-in duration-200 z-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border pb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: cn("h-4 w-4 text-cyan-400", isListening && "animate-spin") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs md:text-sm", children: "জার্ভিস ভয়েস অ্যাসিস্ট্যান্ট" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/40 rounded-xl p-3 border border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground font-semibold", children: "আপনার কথা:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground mt-1 min-h-[16px] leading-relaxed", children: transcript })
        ] }),
        response && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-cyan-500/5 rounded-xl p-3 border border-cyan-500/10 flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "h-3.5 w-3.5 text-cyan-400 shrink-0 mt-0.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cyan-900 leading-relaxed font-semibold", children: response })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: "বলুন:" }),
          ' "স্কুল", "ড্যাশবোর্ড", "স্বাস্থ্য", "বোর্ড", "কুইজ", "ক্লাসমেট" ইত্যাদি।'
        ] })
      ] })
    ] })
  ] });
...
const nav = [
  ...
  { to: "/free-board", label: "বอร์ด", icon: Palette },
...
function AppShell({ children }) {
  ...
  const [openReminders, setOpenReminders] = reactExports.useState(false);
  const [dismissedList, setDismissedList] = reactExports.useState([]);
  const [healthStats, setHealthStats] = reactExports.useState({
    water: 0,
    sleep: 8,
    screen: 2,
  ...
  const loadStats = () => {
    if (typeof window !== "undefined") {
      ...
      const challengeCompleted = savedDate === today && localStorage.getItem("health:challengeCompleted") === "true";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "lg:hidden fixed bottom-3 left-3 right-3 z-40 glass-strong rounded-2xl px-2 py-2 flex items-center justify-around overflow-x-auto", children: nav.slice(0, 8).map((item) => {
      const Icon = item.icon;
      const active = pathname === item.to || pathname.startsWith(item.to + "/");
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-20 right-4 lg:bottom-6 lg:right-6 z-50 flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(VoiceOrb, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: cn("w-5 h-5 md:w-6 md:h-6", activeNotifications.length > 0 && "animate-bounce") }),
              activeNotifications.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 w-5 h-5 bg-rose-500 text-white text-[10px] font-black rounded-full flex items-center justify-center border-2 border-white animate-pulse", children: activeNotifications.length })
            ]
          }
        ),
        openReminders && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-0 bottom-16 md:bottom-20 w-[300px] md:w-[340px] max-h-[420px] glass-strong rounded-[2rem] border border-border shadow-glow p-5 flex flex-col gap-4 text-foreground animate-in slide-in-from-bottom-5 fade-in duration-200 overflow-y-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border pb-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "h-4.5 w-4.5 text-primary animate-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-sm md:text-base", children: "রিমাইন্ডার সেন্টার" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 flex-1 overflow-y-auto pr-1", children: activeNotifications.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-8 text-center text-xs md:text-sm text-muted-foreground flex flex-col items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: "🎉" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-emerald-600", children: "সব কাজ সম্পন্ন হয়েছে!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px]", children: "অসাধারণ! তুমি একদম সুস্থ ও সচল লাইফস্টাইলে আছো।" })
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("p-1.5 rounded-lg bg-white shadow-soft shrink-0", notif.iconColor), children: /* @__PURE__ */ jsxRuntimeExports.jsx(NotifIcon, { className: "h-3.5 w-3.5" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium leading-relaxed text-[11px] md:text-xs", children: notif.text })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end gap-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Link,
                    {
                      to: notif.link,
                      onClick: () => setOpenReminders(false),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/5 rounded-2xl border border-primary/10 p-3 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-wider text-primary font-bold block mb-1", children: "ছাত্র প্রোফাইল" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-muted h-1.5 rounded-full mt-1.5 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[8px] text-muted-foreground block mt-1", children: [
              "পরবর্তী লেভেলে যেতে আরও ",
              250 - user.xp % 250,
              " XP প্রয়োজন"
            ] })
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "fixed left-1/2 -translate-x-1/2 bottom-20 lg:bottom-4 z-30 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-auto glass-strong px-4 py-2 rounded-full text-[11px] md:text-xs text-muted-foreground shadow-soft text-center", children: "Created & Developed by Fardin Hasan, Kachua Govt Pilot High School. A Learning Platform." }) })
  ] });
}
const STORAGE_KEYS = {
...
const $$splitComponentImporter$j = () => import("./school-QeZSIb3e.mjs");
...
const $$splitComponentImporter$h = () => import("./quiz-C0zdeHjj.mjs");
...
const $$splitNotFoundComponentImporter$1 = () => import("./pdf-viewer-yAYHhMnd.mjs");
const $$splitComponentImporter$g = () => import("./pdf-viewer-D-_BvDBD.mjs");
...
const $$splitComponentImporter$f = () => import("./login-DR1mOY7m.mjs");
...
const $$splitComponentImporter$e = () => import("./live-class-BuZ6HXF_.mjs");
...
const $$splitComponentImporter$d = () => import("./library-BPw1rjil.mjs");
...
const $$splitComponentImporter$c = () => import("./leaderboard-BJ5YDPEa.mjs");
...
const $$splitComponentImporter$b = () => import("./free-board-BZEWUPls.mjs");
...
const $$splitComponentImporter$9 = () => import("./dashboard-MXtejoCp.mjs");
...
const $$splitComponentImporter$8 = () => import("./competitions-BbX8MQWK.mjs");
...
const $$splitComponentImporter$7 = () => import("./classmates-Dn30ct3V.mjs");
...
const $$splitComponentImporter$6 = () => import("./certificates-DiGWajhu.mjs");
...
const $$splitComponentImporter$5 = () => import("./bani-D8pDDHGG.mjs");
const Route$7 = createFileRoute("/bani")({
  head: () => ({
    meta: [{
      title: "স্বর্গীয় সহায়িকা AI Core · E-পাঠশালা"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./bangladesh-map-BKJKkjD2.mjs");
...
const $$splitComponentImporter$3 = () => import("./index-D-9xDyjt.mjs");
...
const $$splitNotFoundComponentImporter = () => import("./subjects._slug-CT4hCbxA.mjs");
const $$splitComponentImporter$2 = () => import("./subjects._slug-CV_azV6O.mjs");
...
const $$splitComponentImporter$1 = () => import("./students._studentId-BtTKP7Xt.mjs");
...
const $$splitComponentImporter = () => import("./schools._schoolId-ony-QcQ2.mjs");
