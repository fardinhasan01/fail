...
function requireApi() {
  ...
  hasRequiredApi = 1;
  var Stream = require$$1.Stream, util = require$$0, driver = requireDriver(), EventTarget = requireEvent_target(), Event = requireEvent();
...
function requireClient() {
  ...
  hasRequiredClient = 1;
  var util = require$$0, net = require$$0$2, tls = require$$0$1, url = require$$2, driver = requireDriver(), API = requireApi();
  requireEvent();
...
function requireEventsource() {
  ...
  var Stream = require$$1.Stream, util = require$$0, driver = requireDriver(), Headers = requireHeaders(), API = requireApi(), EventTarget = requireEvent_target(), Event = requireEvent();
...
function requireWebsocket() {
  ...
  var util = require$$0, driver = requireDriver(), API = requireApi();
